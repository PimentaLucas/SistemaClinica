...
public final class JTextFieldValor extends JTextField {
	...
	private void jTextFieldKeyTyped(KeyEvent evt) {
		...
		if ((getText().length() >= getMaximoCaracteres()) && (getMaximoCaracteres() != -1)) {
			...
			// copiado o //conteúdo de algum lugar, ou seja, com tamanho maior que o
			// definido
